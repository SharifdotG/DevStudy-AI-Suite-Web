...
import { registerWithEmail, signInWithGoogle, type AuthState } from "../actions";
    ...
    <div className="mt-8 space-y-6">
      <form action={formAction} className="space-y-5">
        ...
        <PasswordField
          ...
          required
          message="Include a mix of letters and numbers to keep your workspace protected."
        />
      ...
      <p className="text-xs text-foreground/60">
        By continuing you agree to store your study data in Supabase for sync. You can remove your account anytime from your profile.
      </p>
    </div>
  );
}
