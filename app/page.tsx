          ...
          <main className="flex flex-1 flex-col gap-14 pb-16 pt-10 sm:gap-20 sm:pt-14">
                ...
                <div className="flex-1 space-y-6">
                  ...
                  <div className="flex flex-wrap items-center gap-3 pt-2">
                    ...
                    >
                      ...
                      <span className="relative text-base transition-transform group-hover:translate-x-0.5" aria-hidden>
                        ↗
                      </span>
                    </Link>
                    <Link
                    ...
                    <ul className="relative mt-4 space-y-3">
                      {highlights.map((item) => (
                        <li key={item} className="flex items-start gap-3">
                          <span className="mt-1 inline-flex h-2.5 w-2.5 flex-none rounded-full bg-accent" aria-hidden />
                          <span>{item}</span>
                        </li>
                      ))}
                    </ul>
              ...
              {modules.map((module, index) => (
                ...
                >
                  ...
                  <div className="relative flex flex-col gap-4">
                    <span className={`relative inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br text-xl shadow-[0_12px_30px_rgba(15,23,42,0.16)] ${module.accent}`}>
                      {module.icon}
                      <span
            ...
            <section className="space-y-6">
              <div className="flex flex-col gap-2">
                <h2 className="text-3xl font-semibold">Meet the DevStudy crew</h2>
                <p className="text-sm text-foreground/70 sm:text-base">
                  Swap in real teammates later—these placeholders highlight each contributor’s focus area.
                </p>
              </div>
                ...
                {teamMembers.map((member, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <span className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-accent/20 text-sm font-semibold text-accent">
                        {member.name
                          .split(" ")
